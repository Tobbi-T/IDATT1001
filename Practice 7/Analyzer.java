class Analyzer {
    ...
    public static void main(String[] args) {
        Analyzer a = new Analyzer("Hei! Dette er en tekst som består av flere deler. Den er delt opp i tre avsnitt med forskjellig lengde.");
        ...
        System.out.printf("Antall ord: %d\n" +
                        ...
                        "Teksten: %s\n" +
                        "TEKSTEN: %s",
                a.numberOfWords(), a.averageWordLength(), a.averageWordsPerPeriod(), a.replaceAll("er", "ere"), a.getText(), a.getUpperCaseText());
    }
}
