...
public class Property {
  ...
  public String toString() {
    String propertyName =
        this.propertyName != null ? String.format(" har navnet %s,", this.propertyName) : "";
    return String.format(
        "Eiendom \"%s-%s/%s\"%s er eid av %s og har et areal på %s m^2.",
        munNumber, lotNumber, sectionNumber, propertyName, ownerName, area);
  }
